...
>A good way to improve our coding skills is to try to write our own scripts, even if better solutions already exists. For example in the latest weeks I have started to learn Python, so [this](https://github.com/jacopoM28/phy/blob/master/2021/scripts/My_Concat_Script.py) is my solution to convert and concatenate a set of fasta files.
