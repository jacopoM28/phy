...
# Argument Parser
parser = argparse.ArgumentParser(description = 'This script will convert all input fasta files in nexus format, then it will concatenate them in a supermatrix.')
